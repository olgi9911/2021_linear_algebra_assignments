...
Original file is located at
    https://colab.research.google.com/drive/1ZkVLc5zOp9BdvjXnEfrYgeloSE52eYia
"""
...
def PCA(points):
    ...
    for i in range(len(Y)):
      S = np.add(S, np.array([[Y[i][0] * Y[i][0], Y[i][0] * Y[i][1]], [Y[i][0] * Y[i][1], Y[i][1] * Y[i][1]]]))
    B = np.array(len(Y))
    S = S / B
